...
iarduino_ADC_CS1237 adc(13,19);                                                // Создаём объект для работы с функциями библиотеки iarduino_ADC_CS1237, указав выводы ( SCLK , DATA ). Можно указывать любые выводы Arduino.
